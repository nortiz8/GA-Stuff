...
- Students should get comfortable with HTML/CSS and GitHub
...
Refer back to the notes from today and/or use the internet and google to find the answers to the questions below:
...
Grumpy cat (RIP) is looking for a new job! Using what you know about HTML and CSS, help him by creating a resume website for him. (Note: You don't need to know 'real information' about Grumpy Cat -- just make things up!)

This is what he wants you to include and do for his resume:

- have an `index.html` file
- have a `main.css` file that is linked to the `index.html` file
- have HTML `boilerplate` code for `index.html`
  - _HINT:_ in your `index.html` file type `html:5` and press tab. A few basic HTML tags should populate your file, including `head` and `body`
- Include:
  - at least one header
...
Reminder: To open your file with your browser, from the command line, type `code index.html`
...
1. Create links for LinkedIn and Facebook/Twitter pages ('a' tag). You can set this to a dummy link (i.e., `<a href = # >`)
...
- To submit your homework, follow the instructions found in the [wiki](../../../../../../wiki/Homework-Submission). Remember to submit this to the [class repo](https://git.generalassemb.ly/sei-stamford/cerf) in the [issues section](https://git.generalassemb.ly/sei-stamford/cerf/issues).
...
You can continue to work on the homework even after you create the github issue.
