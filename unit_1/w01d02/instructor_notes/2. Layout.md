...
As floats have so many "gotchas", they are best avoided. Modern CSS has much more elegant and simple solutions (we'll learn about them in upcoming lessons). It is still good to know as there are a lot of legacy code out there and you may see these things.

<!-- Let's get back to our mini-project: -->

There is a nice and simple use case for floats, and that is to wrap text around an image in a way you'd find in a newspaper or magazine. Let's go ahead and do that for the content inside our divs with a class of `half`
