...
**Final note:** You are not alone! Everyone else in the class is working on this as well. Send Slack messages or make a Zoom channel.
...
## Deliverables
There are two parts to the how, CSS review videos and JavaScript reps and code challenges. Make sure you attempt each problem

## Submission Guidelines

- Must be submitted no later than before the start of next class
- Create an issue on the class repo. Click the issues tab:
![new issue](https://i.imgur.com/QGngXek.png)
- Click the "New Issue" button
![get started](https://i.imgur.com/ao5GOce.png)
- Click the "Get Started" button
![issues tab](https://i.imgur.com/hWwkOns.png) 
...
Prepare yourself for tomorrow's morning exercise! We're going to flip the classroom! Rather than learn with us and then practice, you'll learn on your own and pratice in class - this will give you a chance to collaborate with classmates and ask instructors questions rather than going it on your own. Watch the following videos on HTML and CSS. You will be working on practicing HTML in your Morning Exercise.
...
- After running the above tasks, console.log the index of "Volver"
