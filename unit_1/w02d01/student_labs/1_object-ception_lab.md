...
1. Wait a second, that's not right! The Milky Way does contain earth, let's fix that! Update the value of *containsEarth* to be true
...
Make planetX a property of system. (Your planetX object is a planet within the system).
