...
app.get('/niles', (req, res) => {
  res.send(
    "You know, sometimes I wonder if I'm not just in pschiatry for the money"
  );
});
...
app.get('/martin', (req, res) => {
  res.send(
    "You may think it's tough being middle-aged, but theink about me. I got a son who's middle-aged."
  );
});
