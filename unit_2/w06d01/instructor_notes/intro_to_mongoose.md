...
- `touch app.js tweet.js`
- `touch .gitignore` and add `node_modules` at the top of the file
- `npm init -y` and in your `package.json` change the `"main"` property from `index.js` to `app.js` 
- `npm i mongoose`
-  `code .`
