...
A brief overview of key dates during project week:
  ...
  - **Friday August 2**: Be in class by 9:00 AM with project proposals ready for approval
  - **Monday August 5**: We will have Outcomes with Anna at 10:00 AM, where we will take a break from project work
  - **Friday August 9**: Project presentation day! We will be meeting at our regular 9:00 AM class time
...
* **A ``README.md`` file** with explanations of the technologies used, the approach was taken, unsolved problems, **wireframes** that you designed during the planning process , and notes to yourself so you can come back to your project later in the course and be able to pick up your train of thought, etc
...
Your project is due on Friday, August 9 at 9:00 AM. You will present your project and show your code to classmates and instructors.

:heavy_check_mark: Add your project to [this google sheet](https://docs.google.com/spreadsheets/d/1mxRuL2LMk2Xik4YT8E7-5Hhv76MgkAEeTjNZ5AKUwSU/edit?usp=sharing).
...
## Inspiration - Projects by Previous WDI/SEI Students
